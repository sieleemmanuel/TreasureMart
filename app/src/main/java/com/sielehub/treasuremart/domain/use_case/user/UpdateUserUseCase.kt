...
class UpdateUserUseCase(private val storeRepository: StoreRepository) {

    suspend operator fun invoke(user: User): Resource<User?> = storeRepository.updateUser(user)
}